...
public class HandlerDataReceiver implements Runnable {
    ...
    public HandlerDataReceiver(DatagramPacket incomingPacket, HandlerPriorityQueue servers) {
    ...
    HandlerServer parseHandlerData(DatagramPacket incomingPacket) {
        ...
        String[] parts = data.split(DELIMITER); //the data comes in the following format: "port:load"

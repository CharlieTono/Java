...
public class DateService {
    ...
    /**
     * The function finds the intersection of two time intervals given the first one is before the second one
     * startADateTime < startBDateTime
     *
     * @return the number of hours
     */

    public int intersectTwoTimeIntervals(ZonedDateTime startADateTime, ZonedDateTime endADateTime, ZonedDateTime startBDateTime, ZonedDateTime endBDateTime) {
    ...
    public boolean isBetween(ZonedDateTime needle, ZonedDateTime start, ZonedDateTime end) {
